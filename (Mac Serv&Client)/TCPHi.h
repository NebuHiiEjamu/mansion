...
OSErr AsyncOpenConnection(
	unsigned long stream,
	long remoteHost,
	short remotePort,
	Byte timeout,
	TCPiopb **returnBlock);		// 6/15/95 JAB

OSErr FinishOpenConnection(
	TCPiopb *returnBlock);		// 6/15/95 JAB
...
/* JAB - 6/13/95 renamed to MyCloseConnection to avoid conflict with UniversalHeaders CodeFragments.h */
OSErr MyCloseConnection(			/* closes an established connection					*/
